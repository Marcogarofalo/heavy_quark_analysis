...
```{r, echo=FALSE, results='asis', warning=FALSE}
file<-"/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_th6_t56_44_nobin.dat_fit_HLT_Z0-sigma_fit_data.txt"
...
for (n in c(1:1)){
          ...
          file=sprintf("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_th6_t56_44_nobin.dat_fit_HLT_Z0-sigma_fit_out_n%d_sigma.txt",n-1)
...
```{r, echo=FALSE, results='asis', warning=FALSE}
file<-"/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_th6_t56_44_nobin.dat_fit_HLT_Z1-sigma_fit_data.txt"
df<- read.table(file, header=FALSE, fill=TRUE)
...
for (n in c(1:1)){
          ...
          file=sprintf("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_th6_t56_44_nobin.dat_fit_HLT_Z1-sigma_fit_out_n%d_sigma.txt",n-1)
          #if(!file.exists(file)){next}
          datalist[[n]]<- read.table(file, header=FALSE, fill=TRUE,   
                                     col.names=c(paste0("x",n),paste0("fit",n),paste0("fiterr",n)))
