...
```{r, echo=FALSE, results='asis', warning=FALSE}
mt<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_ins40_ins56_th6.dat_output")
all_obs<- get_all_corr(mt)
...
# n<- which(all_obs[,"corr"]=="E3_0_vev")
# all_obs[n,"chi2.dof"]
dfa<-read.table("/home/garofalo/Downloads/z0_iset0_ab110.dat")
...
dfa<-dfa[-1,]
#gg<-gg+ geom_point(aes(x=dfa[,1], y=df[c(1:40),2]/dfa[,2] ), color="blue")
