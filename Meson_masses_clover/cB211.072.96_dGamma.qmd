...
for (i in seq_along(ths) ){
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z0-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z1-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z1"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z2-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z2"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_part_Z0-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"part-Z0"
...
mt1<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.96_th9.5_t56_44.dat_HLT_kernel")
...
###################### MG
for (th in c("1","3","9")){
mt1<-read_df(paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.96_th",th,"_t56_44.dat_HLT_kernel"))
all_obs<- get_all_corr(mt1)
