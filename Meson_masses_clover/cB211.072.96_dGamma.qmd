...
for (i in seq_along(ths) ){
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z0-sigma_fit_P.dat"))
  dG[count]<-P$P[1,2]
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z1-sigma_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z1"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_Z2-sigma_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z2"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_part_Z0-sigma_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"part-Z0"
  count<- count+1
  ########
  fit<-get_full_res("dGammadq_part_GEV3", all_obs, mt)
  dG[count]<-fit[1,1]
  dG_err[count]<-fit[1,2]
  q2[count]<-fit[1,3]
...
cat("\n## ",Z,"\n\n")
for (i in seq_along(ths) ){
  file<-paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.96_th",ths[i],"_t56_44.dat_fit_HLT_",Z,"-sigma")
