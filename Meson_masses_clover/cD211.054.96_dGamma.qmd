...
for (i in seq_along(ths) ){
  mt<-read_df(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_output"))
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_Z0-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  ...
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_Z1-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z1"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_Z2-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"Z2"
  count<- count+1
  #####
  P<-read_fit_P_file(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_part_Z0-sigma4_fit_P.dat"))
  dG[count]<-P$P[1,2]
  dG_err[count]<-P$P[1,3]
  q2[count]<-fit[1,3]
  label[count]<-"part-Z0"
...
cat("\n## ",Z,"\n\n")
for (i in seq_along(ths) ){
  file<-paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_",Z,"-sigma4")
  ...
  for (s in c(0.005,  0.010,  0.020,  0.030,  0.050,  0.070,
    ...
    si<-sprintf("%f",s)
   P<-read_fit_P_file(paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_",Z,"-sig",si,"-alpha_fit_P.dat"))
   file<-paste0(dir,"cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_",Z,"-sig",si,"-alpha_fit_data.txt")
...
df<-NULL
fileA<-paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th",ths[i],"_t78_62.dat_HLT_AoverB")
mtA<-read_df(fileA)
...
mt1<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th9.5_t78_62.dat_HLT_kernel")
...
###################### MG
for (th in c("1","3","9")){
mt1<-read_df(paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th",th,"_t78_62.dat_HLT_kernel"))
all_obs<- get_all_corr(mt1)
...
df<-NULL
file<-paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th",ths[i],"_t78_62.dat_output")
mt1<-read_df(file)
all_obs<- get_all_corr(mt1)
