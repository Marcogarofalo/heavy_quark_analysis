...
cat("\n## ",Z,"\n\n")
for (i in seq_along(ths) ){
  file<-paste0("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th",ths[i],"_t78_62.dat_fit_HLT_",Z,"-sigma")
 ...
 for (s in c(0.005,  0.010,  0.020,  0.030,  0.050,  0.070,
              ...
              0.330,  0.350,  0.400,  0.500 ) ){    si<-sprintf("%f",s)
...
name<-paste0("D96_",Z,"_th",ths[i],".pdf")
...
df<-NULL
###################### MG
mt1<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cD211.054.96_th3_t78_62.dat_HLT_kernel")
