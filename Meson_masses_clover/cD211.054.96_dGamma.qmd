...
dfA$x<-dfA$x-log2(dfA[,12])# A/A0_ref
dfA$xfit<-dfA$xfit-log2(dfA[,12])# A/A0_ref
dfA$tmin<-dfA$tmin-log2(dfA[,12])# A/A0_ref
dfA$tmax<-dfA$tmax-log2(dfA[,12])# A/A0_ref
gg<- plot_df_corr_ggplot(dfA,width = 0.05)
fig<- myplotly(gg,"","log2(A/A0)_ref", paste0("rho-th",ths[i]), to_print=TRUE )
