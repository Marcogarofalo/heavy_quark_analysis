...
df1<-add_corr_to_df(string ="HLT_Z0-sig0.120-alpha0.00", all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE, rename="MG-Z0-alpha1")
...
all_obs<- get_all_corr(mt1)
df1<-add_corr_to_df(string ="HLT_Z0-sig0.120-alpha0.00_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = NULL,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z0-sig0.120-alpha0.00_lam32.0000",  
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z0-sig0.120-alpha2.00_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
...
mt1<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_ins48_ins64_th6.dat_output")
all_obs<- get_all_corr(mt1)
df1<-add_corr_to_df(string ="HLT_Z1-sig0.120-alpha2.00", all_obs=all_obs,mt=mt1,df = NULL,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE, 
                   ,rename="MG-Z1-alpha0")

df1<-add_corr_to_df(string ="HLT_Z1-sig0.120-alpha0.00", all_obs=all_obs,mt=mt1,df = df1,
...
mt1<-read_df("/home/garofalo/analysis/heavy_quarks/data_Inc/out/cB211.072.64_ins48_ins64_th6.dat_HLT_kernel")
all_obs<- get_all_corr(mt1)
df1<-add_corr_to_df(string ="HLT_Z1-sig0.120-alpha0.00_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = NULL,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z1-sig0.120-alpha0.00_lam32.0000",
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z1-sig0.120-alpha2.00_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
# res<- get_res(string ="HLT_Z0-sig0.120-alpha1_lam16384.0000",all_obs=all_obs,mt1)
# df1<-add_corr_to_df(string ="HLT_Z0-sig0.120-alpha1-E0o2_lam16384.0000", all_obs=all_obs,mt=mt1,df = df1,
