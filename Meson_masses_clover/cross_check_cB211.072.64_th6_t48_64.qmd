...
# df1<-add_corr_to_df(string ="HLT_Z0-alpha1", all_obs=all_obs,mt=mt1,df = df1,
...
all_obs<- get_all_corr(mt1)
df1<-add_corr_to_df(string ="HLT_Z0-alpha1_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = NULL,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z0-alpha1_lam32.0000",  
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
df1<-add_corr_to_df(string ="HLT_Z0-alpha0_lam16384.0000",
                    all_obs=all_obs,mt=mt1,df = df1,
                   log = FALSE, number = NULL,nudge = 0,print_res = FALSE)

# df1<-add_corr_to_df(string ="HLT_Z0-alpha1-E0o2_lam16384.0000", all_obs=all_obs,mt=mt1,df = df1,
#                    log = FALSE, number = NULL,nudge = 0,print_res = FALSE)
