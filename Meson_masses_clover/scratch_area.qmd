...
- We could iterate the procedure and use as base $b_t''=\frac{e^{-Et}}{t^2}$ to     approximate $\Delta''$
$$\Delta''=\int\int \theta_0(\omega-\omega_0)\approx \frac{1}{2} (\omega-\omega_0)^2\theta_0(\omega-\omega_0)$$
...
for (i in seq_along(ths) ){
  ...
  gg<-custom_plot_fit(file,"sigma", "$-(\\omega-\\omega_0)\\theta_0(\\omega-\\omega_0)$" , gg=gg,nudge = 0.0002)
  ...
  gg<-custom_plot_fit(file,"sigma", "$0.5(\\omega-\\omega_0)^2\\theta_0(\\omega-\\omega_0)$" , gg=gg,nudge = 0.0004)
  ...
  gg<-custom_plot_fit(file,"sigma", "$\\theta_0^{algebraic}(\\omega-\\omega_0)$" , gg=gg,nudge = 0.0004)
