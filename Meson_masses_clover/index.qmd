...
df<-add_corr_to_df("M_{Ds}(c0,s0)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c0,s1)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c0,s2)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c1,s0)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c1,s1)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c1,s2)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c2,s0)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c2,s1)",all_obs,mt,df)
df<-add_corr_to_df("M_{Ds}(c2,s2)",all_obs,mt,df)
