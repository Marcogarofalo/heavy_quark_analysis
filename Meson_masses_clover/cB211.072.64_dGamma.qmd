...
dfA$x<-dfA$x-log10(dfA[,12])# A/A0
dfA$xfit<-dfA$xfit-log10(dfA[,12])# A/A0
dfA$tmin<-dfA$tmin-log10(dfA[,12])# A/A0
dfA$tmax<-dfA$tmax-log10(dfA[,12])# A/A0
gg<- plot_df_corr_ggplot(dfA,width = 0.01)
fig<- myplotly(gg,"","log10(A/A0)", paste0("rho-th",ths[i]), to_print=TRUE )
